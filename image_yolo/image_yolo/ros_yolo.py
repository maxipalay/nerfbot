...
class Camera_subscriber(Node):
    def __init__(self):
        ...
        self.model = YOLO(
            "/home/jialuyu/ws/final_project_ROS/final-project-group2/image_yolo/image_yolo/best.pt"
        )
                ...
                if class_name != "not_pins":  # Exclude class "not_pins"
                    if class_name == "red_pins" and box.conf > 0.5:
                        ...
                        for i in red_pins:
                            ...
                            self.point_r.point.x = i[
                                2
                            ]  # i[0]  # Set x, y, z coordinates
                        ...
                        for j in yellow_pins:
                            ...
                            self.point_y.point.x = j[
                                2
                            ]  # j[0]  # Set x, y, z coordinates
                        ...
                        for k in green_pins:
                            ...
                            self.point_g.point.x = k[
                                2
                            ]  # k[0]  # Set x, y, z coordinates
                        ...
                        for l in blue_pins:
                            ...
                            self.point_b.point.x = l[
                                2
                            ]  # l[0]  # Set x, y, z coordinates
